'''
Simple data analysis using Python and Sql from an American Community Survey on job outcome statistics based on college majors
...
DEFAULT_PATH = os.path.join(os.getcwd(),'~/db/jobs.db')
